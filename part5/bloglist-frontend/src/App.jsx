...
const App = () => {
  ...
  const handleLikes = async(blog) => {
    ...
    setBlogs(prevBlogs => prevBlogs.map(prevBlog => prevBlog.id === likedBlog.id?likedBlog:prevBlog))
  }
  ...
  if(user.username){
    return (
      <div>
        ...
        <hr />
        {blogs.map(blog =>
          <Blog key={blog.id} blog={blog} deleteBlog={deleteBlog} handleLikes={handleLikes} user={user}/>
        )}
      </div>
    )
  }
